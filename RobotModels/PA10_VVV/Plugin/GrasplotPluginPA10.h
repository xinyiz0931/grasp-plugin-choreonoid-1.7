...
#ifndef GRASPLOTPLUGIN_PA10_VVV_H
#define GRASPLOTPLUGIN_PA10_VVV_H
...
//using namespace cnoid;
//using namespace cnoid::Robotics;
...
//		virtual bool IK_arm(const cnoid::Vector3 &p, const cnoid::Matrix3 &R);
		...
		bool  IK_arm(const cnoid::Vector3& p, const cnoid::Matrix3& R, double phi, const cnoid::VectorXd& q_old);
		/*
